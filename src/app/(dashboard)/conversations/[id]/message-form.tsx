  ...
  if (pickedFile) {
    ...
    return (
      <form
        ref={mediaFormRef}
        action={mediaAction}
        className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3"
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-2 px-2 py-1.5 rounded-lg bg-slate-50 dark:bg-slate-800">
          {isImage ? (
        ...
        <div className="flex gap-2 items-end">
          <input
            ...
            className="flex-1 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-orange-500"
          />
          <button
            type="submit"
            disabled={pending}
            className="shrink-0 h-9 px-3 rounded-lg bg-brand-orange-500 hover:bg-brand-orange-600 disabled:opacity-60 text-white text-sm font-medium flex items-center gap-1.5"
          >
    ...
    >
      ...
      {quickOpen && quickReplies.length > 0 && (
        <>
          ...
          <div className="absolute bottom-full left-3 mb-1 z-20 w-80 max-h-64 overflow-y-auto rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-lg py-1">
            {quickReplies.map((r) => (
              <button
                key={r.id}
                type="button"
      ...
      <div className="flex gap-2 items-end">
        <button
          ...
          className="shrink-0 h-9 w-9 rounded-lg text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 flex items-center justify-center transition"
        ...
        <button
          ...
          className="shrink-0 h-9 px-2 rounded-lg text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 flex items-center gap-1 transition disabled:opacity-40 disabled:hover:bg-transparent"
          title={
        ...
        <textarea
          ...
          className="flex-1 resize-none rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-orange-500"
          onKeyDown={(e) => {
        ...
        <button
          type="submit"
          disabled={pending}
          className="shrink-0 h-9 px-3 rounded-lg bg-brand-orange-500 hover:bg-brand-orange-600 disabled:opacity-60 text-white text-sm font-medium flex items-center gap-1.5 transition"
        >
          <Send className="h-3.5 w-3.5" />
          {pending ? "..." : "Enviar"}
        </button>

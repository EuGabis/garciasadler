  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-xs text-zinc-700 dark:text-zinc-300 transition"
      >
...
function CreateColumnForm() {
  ...
  return (
    <form action={formAction} className="space-y-2 p-3 rounded-lg border border-zinc-200 dark:border-zinc-800">
      <p className="text-xs font-semibold text-zinc-500">Nova coluna</p>
...
function ColumnRow({ column }: { column: Column }) {
  ...
  if (editing) {
    return (
      <form
        action={formAction}
        className="p-3 rounded-lg border border-indigo-300 dark:border-indigo-700 bg-indigo-50 dark:bg-indigo-950/30 space-y-2"
      >
  ...
  return (
    <div className="flex items-center gap-3 p-2.5 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition">
      <span
